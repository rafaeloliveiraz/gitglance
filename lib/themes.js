...
//
// Optional capability flags let a theme opt into behavior beyond a plain
// palette swap. See docs/THEMES.md for what each one does and when to use it:
//   pixelFont   - route rendered SVG text through lib/pixel-text.js
//   noTitleBar  - suppress the small underline drawn below card titles
//   ringColors  - override the default per-stat colors on ring gauge cards
//   ringTrack   - override the background track color on ring gauge cards
const THEMES = {
  kangel: {
    bg: "f0d1f1", panel: "fff8ff", title: "4e23cf", text: "4e23cf", muted: "4e23cf", accent: "91f3e4", border: "4e23cf",
    pixelFont: true,
    noTitleBar: true,
    ringColors: ["4d21cb", "6cb2e0", "e64c55", "8cf0e0"],
    ringTrack: "ee98ee",
  },
